...
// Función para asignar color según el valor de la estadística
function colorStat(value) {
  if (value >= 180) return "#00FF00";  // Alto (verde)
  if (value >= 100) return "#FFD700";  // Medio (amarillo)
  return "#FF6347";  // Bajo (rojo)
}
